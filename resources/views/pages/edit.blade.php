...
@section('content')
    ...
    <form action="{{ route('siswa.update', $siswa->id) }}" method="POST">
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="text" name="tempat_lahir" class="form-control"
                    value="{{ old('tempat_lahir', $siswa->tempat_lahir) }}" placeholder="Tempat Lahir">
            </div>
            <div class="col-md-6 mb-3">
        ...
        <div class="mb-3">
            ...
            <textarea name="alamat" class="form-control" rows="3" placeholder="Alamat">{{ old('alamat', $siswa->alamat) }}</textarea>
        </div>
        <div class="mb-3">
            <label for="asal_sekolah" class="form-label">Asal Sekolah</label>
            <input type="text" name="asal_sekolah" class="form-control"
                value="{{ old('asal_sekolah', $siswa->asal_sekolah) }}" placeholder="Asal Sekolah">
        </div>
        <div class="mb-3">
